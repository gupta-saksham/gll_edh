...
The selected family response is policy 31 (`instant_slow_stagger_1h`). Values are means over the independent test weeks. Group prices are CHF per actual behind-meter load kWh; parentheses show the difference from `fair_leg/base`, where positive is worse.
...
| `voltage_price/selected_family` | 59.20 | 8.26 | 6.85 | 0.38% | 304.86 | +0.035 (-0.188) | -0.299 (-0.036) | -0.358 (+0.063) | -0.105 (+0.043) |
